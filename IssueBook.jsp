...
<button class="btn btn-success" data-toggle="modal" data-target="#issueModal">Click to Issue Book</button>
</div>
...
<table class="table table-striped container text-center">
  ...
  <%
	...
	<% 
		...
		if(count==0)
		{
			response.sendRedirect("IssueBook1.jsp");
		}
	%>
	<tbody>
    <%
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body" style="font-weight: bold">
		        <form action="Issueconfirm" method="post">
		        <div class="form-group">
				    <label>Book ID</label>
				    <input type="text" name="bookid" class="form-control" id="bookid" aria-describedby="nameHelp" placeholder="Enter book id">
				  </div>
		        <div class="form-group">
				    <label>Username</label>
				 <input type="text" name="issuerusername" class="form-control" id="issuername" aria-describedby="nameHelp" placeholder="Enter username">
				  </div>
				  <div class="form-group">
				    <label for="exampleInputEmail1">Email address</label>
				    <input type="email" name="issueremail" class="form-control" id="issueremail" aria-describedby="emailHelp" placeholder="Enter email">
