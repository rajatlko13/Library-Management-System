...
<div class="jumbotron text-center mb-0 mt-2">
  ...
  <%
	  try
	  {
		...
		String query1="select * from originalbooklist where id='"+bookid+"'";
		...
		rs1.next();
	%>
	<div class="container my-5 font-weight-bold" style="font-size:18px">
	<span class="col-lg-6 text-danger">Book ID : </span><%=rs1.getString("id") %>
	<span class="col-lg-6 text-danger" style="margin-left:200px">Book Name : </span><%=rs1.getString("name") %><br>
	<span class="col-lg-6 text-danger">Author : </span><%=rs1.getString("author") %>
	<span class="col-lg-6 text-danger" style="margin-left:130px">Pages : </span><%=rs1.getString("pages") %><br>
	<span class="col-lg-6 text-danger">Publisher : </span><%=rs1.getString("publisher") %>
	<span class="col-lg-6 text-danger" style="margin-left:100px">Total Copies : </span><%=rs1.getString("totalcopies") %><br>
	<span class="col-lg-6 text-danger">Copies Available : </span><%=rs1.getString("copies") %><br>
	</div>

	<% 
	String query2="select * from book"+bookid;
...
<table class="table table-striped container text-center">
  <thead class="thead-dark">
	...
	<tr>
        ...
        <td><%=rs2.getString("issuedate") %></td>        
        <td><%=rs2.getString("returndate") %></td>
     </tr>
	<% 
	}		
	%>
