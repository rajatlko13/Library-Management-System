...
<form class="container mx-auto my-4 bg-light py-2" style="width: 50%; font-weight: bold" action="Addconfirm" method="post">
<h1 class="text-center">Add Books</h1>
<hr class="w-50">
	<div class="form-group mt-4">
		<label>Book Id</label>
	    <input type="text" name="bookid" class="form-control" id="exampleInputId" placeholder="Enter book id">
	</div>
	<div class="form-group">
		<label for="exampleInputName">Book Name</label>
	    <input type="name" name="name" class="form-control" id="exampleInputName" aria-describedby="nameHelp" placeholder="Enter book name">
	</div>
  <div class="form-group">
    <label>Author</label>
    <input type="text" name="author" class="form-control" id="exampleInputAuthor" placeholder="Enter author's name">
  </div>
  <div class="form-group">
    <label>Pages</label>
    <input type="number" name="pages" class="form-control" id="exampleInputPages" placeholder="Enter pages">
  </div>
 <div class="form-group">
    <label>Publisher</label>
    <input type="text" name="publisher" class="form-control" id="exampleInputPublisher" placeholder="Enter publisher">
  </div>
  <div class="form-group">
    <label>Copies</label>
    <input type="number" name="copies" class="form-control" id="exampleInputCopies" placeholder="Enter copies">
  </div>
