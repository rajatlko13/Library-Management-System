...
<div class="jumbotron text-center mb-0 mt-2">
  ...
  <%
	  try
	  {
		...
		String query1="select * from studentsignup where email='"+email+"'";
	...
	<span class="col-lg-6 text-danger">Name : </span><%=rs1.getString("name") %>
	<span class="col-lg-6 text-danger" style="margin-left:200px">Contact : </span><%=rs1.getString("contact") %><br>
	<span class="col-lg-6 text-danger">Email : </span><%=rs1.getString("email") %>
	<span class="col-lg-6 text-danger" style="margin-left:100px">Username : </span><%=rs1.getString("username") %><br>
	</div>
